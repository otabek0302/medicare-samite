...
1
  return (
    <Box p={4} borderRadius="md" boxShadow="md" bg={colorMode === "dark" ? theme.colors.gray[900] : "#fff"} border={"1px solid rgba(0,0,0,0.5)"}>
      ...
      {appointmentData && (
        <Calendar
          ...
          style={{
            height: 500,
            backgroundColor: colorMode === "dark" ? theme.colors.gray[900] : "#fff",
          ...
          min={new Date(startOfWeek.getFullYear(), startOfWeek.getMonth(), startOfWeek.getDate(), 7, 0)} // Start from 7:00 AM
          max={new Date(startOfWeek.getFullYear(), startOfWeek.getMonth(), startOfWeek.getDate(), 18, 0)}
...
const CustomEvent = ({ event }) => {
  ...
  return (
    <Box borderRadius="md">
      <Text fontWeight="400" style={eventStyleGetter(event)} py={"2px"} px={2} fontSize={"xs"}>
        {start} {event.title}
      </Text>
