      ...
      <ModalContent
        ...
        <ModalBody>
          <Box pb={3}>
            <FormControl isRequired>
              <FormLabel>{t('cities.update.form.title.label')}</FormLabel>
              <Input
                defaultValue={data?.title}
                placeholder={t('cities.update.form.title.placeholder')}
        ...
        <ModalFooter py={3}>
          ...
          <Button
            ...
            type="submit"
            isLoading={isLoading}>
            {t('cities.update.buttons.update')}
          </Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
