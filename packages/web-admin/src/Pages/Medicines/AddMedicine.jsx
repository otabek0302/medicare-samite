            ...
            {hasPermission("MEDICINE_ADD") ? (
              <>
                <FormControl isRequired>
                  ...
                  <Input size={"md"} placeholder={t("medicines.add.form.name.placeholder")} {...register("title", { required: true })} />
                </FormControl>
                <FormControl mt={3}>
                  <FormLabel fontSize={"sm"}>{t("medicines.add.form.notes.label")}</FormLabel>
                  <Textarea size={"md"} placeholder={t("medicines.add.form.notes.placeholder")} {...register("notes")} />
                </FormControl>
              </>
            ) : (
              <NotAuth />
